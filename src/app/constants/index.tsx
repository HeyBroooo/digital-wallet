import feature1Icon from "../public/images/feature-1.png";
import feature2Icon from "../public/images/feature-2.png";
import detail1Icon from "../public/images/detail-1.png";
import detail2Icon from "../public/images/detail-2.png";
import detail3Icon from "../public/images/detail-3.png";
import detail4Icon from "../public/images/detail-4.png";
import circleIcon from "../public/images/circle.svg";
import triangleIcon from "../public/images/triangle.svg";
import hexagonIcon from "../public/images/hexagon.svg";
import plan1Logo from "../public/images/plan-1.png";
import plan2Logo from "../public/images/plan-2.png";
import plan3Logo from "../public/images/plan-3.png";
import magictouchIcon from "../public/images/magictouch.svg";
import docsIcon from "../public/images/docs.svg";
import xIcon from "../public/images/socials/x.svg";
import threadsIcon from "../public/images/socials/threads.svg";
import instagramIcon from "../public/images/socials/instagram.svg";
import discordIcon from "../public/images/socials/discord.svg";
import jesica from "../public/images/testimonials/jessica-saunders.png"
import mark from "../public/images/testimonials/mark-erixon.png"
import mali from "../public/images/testimonials/melanie-hurst.png"
import unknown from "../public/images/testimonials/alicia-barker.png"
...
export const features = [
  {
    ...
    title: "Bank-Grade Security for Your Digital Assets",
    text: "Multi-signature protection, biometric authentication, and encrypted storage keep your cryptocurrencies safe and secure.",
    button: {
      icon: magictouchIcon,
  ...
  },
  {
    ...
    title: "Seamless Trading Across Multiple Chains",
    text: "Trade cryptocurrencies across different blockchains with real-time pricing and minimal fees.",
    button: {
      icon: docsIcon,
      title: "Read the docs",
    },
...
export const faq = [
  {
    ...
    answer:
      "A crypto wallet is a digital tool that allows you to securely store, send, and receive cryptocurrencies. It’s essential for managing your digital assets and interacting with blockchain applications.",
  },
  {
    id: "1",
    question: "What’s the difference between a hardware wallet and a software wallet?",
    answer:
      "A hardware wallet is a physical device that stores your private keys offline, providing enhanced security. A software wallet is an app or web service that allows quick access to your funds but may be more vulnerable to online threats.",
  },
  {
    id: "2",
    question: "Can I store multiple cryptocurrencies in one wallet?",
    answer:
      "Yes, many wallets support multiple cryptocurrencies, including Bitcoin, Ethereum, and various tokens. Check your wallet's compatibility list to ensure it supports the assets you want to store.",
  },
  {
    id: "3",
    question: "How do I ensure the security of my crypto wallet?",
    answer:
      "Use strong passwords, enable two-factor authentication, and back up your private keys or recovery phrases. For higher security, consider using a hardware wallet for long-term storage.",
  },
  {
    id: "4",
    question: "Can I recover my wallet if I lose my private key or device?",
    answer:
      "If you’ve backed up your recovery phrase or private key, you can restore your wallet on a new device. Without these, it’s impossible to recover your funds, so keep backups in a safe place.",
  },
  {
    id: "5",
    question: "What are gas fees in cryptocurrency transactions?",
    answer:
      "Gas fees are the transaction costs you pay to miners or validators for processing your transactions on a blockchain. The fees vary based on network congestion and the blockchain you're using.",
  },
  {
    id: "6",
    question: "Can I connect my crypto wallet to decentralized applications (DApps)?",
    answer:
      "Yes, most wallets support connecting to DApps for tasks like trading, lending, or interacting with DeFi platforms. Ensure the DApp is trusted before granting access to your wallet.",
  },
  {
    id: "7",
    question: "What should I do if I suspect my wallet has been compromised?",
    answer:
      "Immediately transfer your funds to a new wallet and revoke access to any DApps linked to the compromised wallet. Avoid sharing private keys or recovery phrases with anyone.",
  },
  {
    id: "8",
    question: "Is it safe to use a wallet on a mobile device?",
    answer:
      "Mobile wallets are convenient for on-the-go transactions but may be less secure than hardware wallets. Use strong passwords and avoid accessing your wallet on public Wi-Fi networks.",
  },
  {
    id: "9",
    question: "What’s the best way to manage a large cryptocurrency portfolio?",
    answer:
      "Consider using a wallet with advanced portfolio management features, such as detailed analytics, tax reporting, and multi-user access. For institutional needs, explore enterprise-grade wallets with enhanced security and support.",
  },
];
...
export const logos = [
  {
    id: "0",
    title: "Bitcoin",
    url: "https://cryptologos.cc/logos/bitcoin-btc-logo.svg",
    width: 50,
    height: 50,
  },
  {
  ...
  },
  {
    id: "2",
    title: "Ripple",
    url: "https://cryptologos.cc/logos/xrp-xrp-logo.svg",
    width: 50,
    height: 50,
  },
  {
    id: "3",
    title: "Litecoin",
    url: "https://cryptologos.cc/logos/litecoin-ltc-logo.svg",
    width: 50,
    height: 50,
  },
  {
    id: "4",
    title: "Tether",
    url: "https://cryptologos.cc/logos/tether-usdt-logo.svg",
    width: 50,
    height: 50,
  },
];
